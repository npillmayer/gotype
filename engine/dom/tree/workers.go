...
type workergroup struct {
	...
	workload   chan workPackage // in-out channel for work packages
	errorch    chan<- error     // output channel for error messages
}
...
type workerTask func(wpData interface{}) (*Node, error)

// workPackage is a unit of work, packaging the operation as well as
// the data to operate on.
type workPackage struct {
	promise *promise    // pipeline step this workpackage is for
	todo    workerTask  // task to perform
	data    interface{} // data to operate on
}
